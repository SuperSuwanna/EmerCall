...
import suwannarod.snru.ac.th.emercall.utility.HospitalAdapter;
...
//          Create ListView
        ...
        String[] titleStrings = new  String[]{"Hospital 1","Hospital 2","Hospital 3",
                "Hospital 4","Hospital 5","Hospital 6","Hospital 7","Hospital 8",};

        String[] phoneStrings = new  String[]{"1111","1112","1113",
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_hopital1, container, false);
        return view;
